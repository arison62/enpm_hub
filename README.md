ENSPM Hub - Réseau des Alumni, Étudiants et Partenaires

Application web moderne du réseau professionnel de l'ENSPM. Accédez à des offres de stage, d'emploi et de formation. Bénéficiez du mentorat d'anciens diplômés et collaborez sur des projets innovants.
...
```
enpsm_hub/
├── enspm_hub/             # Configuration Django principale
...
```bash
git clone https://github.com/arison62/enspm_hub.git
cd enspm_hub
```
...
DATABASE_URL=postgresql://utilisateur:mot_de_passe@localhost:5432/enspm_hub_db

# Autres configurations
DJANGO_SETTINGS_MODULE=enspm_hub.settings
```
